...
func declaringVariables() {
    ...
    print("13| http404Error=\(http404Error), type:\(type(of:http404Error))")
    ...
    let (status2, description2) = http200Status
    print("17| status2=\(status2), description2=\(description2)")
}
